...
(function($) {
	...
	skel.init({
		reset: 'full',
		breakpoints: {
			global: { href: 'css/style.css', containers: '70em', grid: { gutters: ['2em', 0] } },
			xlarge: { media: '(max-width: 1680px)', href: 'css/style-xlarge.css' },
			large: { media: '(max-width: 1280px)', href: 'css/style-large.css', containers: '65em', grid: { gutters: ['1.5em', 0] }, viewport: { scalable: false } },
